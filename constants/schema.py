...
EMPTY_CONFIG_DATA = {
    ...
    "ROOTS": {
        f"{FOLDERNAME_ROOT}01": None,
        f"{FOLDERNAME_ROOT}02": None,
    },
    "BASEFOLDERS": {
        f"{FOLDERNAME_BASE}01": ["LINKED01"],
        f"{FOLDERNAME_BASE}02": ["test"],
    },
    "LINKED01": {"photos": [None]},
    "LINKED02": {"supports": [None], "noSupports": [None]},
    "LINKED03": {"objs": ["LINKED02"], "maya": [None], "stl": ["LINKED02"]},
    "validExt": [
        ".ma",
        ".mb",
        ".obj",
